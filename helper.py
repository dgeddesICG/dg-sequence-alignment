# JT May 2024: this file was recovered from an old version of cjn-sequence-alignment that I found.
# Chas retired that module, but j_postacquisition still had a dependency on convertObj.
import math
import numpy as np
