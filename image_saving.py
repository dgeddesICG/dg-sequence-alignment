...
def GenerateFakePlists(basePath, framerate=1000.0, stemLength=0, fakeZScan=False, fakeMip=False):
    ...
    for file in os.listdir(basePath):
        if (file.endswith(".tif") or file.endswith(".tiff")):
            ...
            if fakeZScan:
                ...
                # Optional hacky workaround to provide some dummy information to satisfy MovieBuilder/StackViewer
                pl['z_scan'] = dict()
                pl['z_scan']['repeat_info'] = dict()
                pl['z_scan']['repeat_info']['repeat_counter'] = counter
            counter = counter + 1
